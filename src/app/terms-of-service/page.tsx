  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        <p className="text-sm text-gray-600 mb-8">最后更新日期：2025年11月21日</p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">1. 接受条款</h2>
          <p>通过访问和使用Learn English with Songs服务，您同意受本服务条款的约束。如果您不同意这些条款，请勿使用我们的服务。</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">2. 服务描述</h2>
          <p>Learn English with Songs是一款帮助用户通过歌曲学习英语的应用程序。我们提供歌词显示、注释、词汇学习和收藏功能。</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">3. 用户账户</h2>
          <p>您须提供准确、完整的信息来注册账户。您负责维护账户的安全性，并对所有使用您的账户进行的活动负责。</p>
        </section>
